...
def create_datasets(dataset_name):
    ...
    os.mkdir(f'data_folder/datasets/{dataset_name}')

    torch.save(training_set, f'data_folder/datasets/{dataset_name}/train.pt')
    torch.save(val_set, f'data_folder/datasets/{dataset_name}/val.pt')

def load_datasets(dataset_name):
    training_set = torch.load(f'data_folder/datasets/{dataset_name}/train.pt')
    val_set = torch.load(f'data_folder/datasets/{dataset_name}/val.pt')
