...
from neural_network_stuff.custome_DETR.misc_stuff import NestedTensor, is_main_process
...
def build_backbone():
    ...
    train_backbone = 1e-5 #args.lr_backbone > 0    Learning rate for the backbone
